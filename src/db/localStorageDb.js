...
function LocalStorageDb(options) {
  ...
  let _dbKey = options.dbKey || "db";

  let _changeSet = [];  // [{"action": "add/remove", "obj": dbEntry}, {...}, ...]
  let _stagedClear = false;  // db needs clearing before applying other change-sets
  ...
  this.refresh = function () {
    ...
    _changeSet = [];
    _stagedClear = false;  // TODO: update logic
  };
